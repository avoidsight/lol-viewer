...
describe('MatchCache', () => {
  ...
  it('runs migrations idempotently and records each version once', () => {
    ...
    expect(database.prepare('SELECT version FROM schema_migrations ORDER BY version').all()).toEqual([{ version: 1 }, { version: 2 }, { version: 3 }, { version: 4 }, { version: 5 }, { version: 6 }, { version: 7 }]);
