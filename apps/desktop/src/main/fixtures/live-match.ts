...
function personalMatchesFor(target?: PersonalHistoryTarget): MatchSummary[] {
  ...
  return Array.from({ length: 20 }, (_, matchIndex) => {
    ...
    return {
      ...
      ...(matchIndex === 2 ? { kills: 12, deaths: 2, assists: 16, killParticipation: .7, teamDamageShare: .35, teamDamageTakenShare: .3, achievements: [{ type: 'MOST_DAMAGE' as const, value: 42000 }, { type: 'MOST_DAMAGE_TAKEN' as const, value: 38000 }] } : {}),
