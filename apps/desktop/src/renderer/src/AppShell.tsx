...
export default function AppShell({ active, onChange, children, liveAttention = false, onFeedback, support }: {
  ...
  return <div className="app-shell"><nav className="app-shell__bar" aria-label="主导航"><div className="app-shell__tabs" role="tablist" aria-label="功能页面">{tabs.map(({ id, label }) => {
